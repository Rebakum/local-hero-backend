...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('NEW_QUOTE', 'QUOTE_RESPONSE', 'BOOKING_REQUEST', 'BOOKING_CONFIRMATION', 'BOOKING_REMINDER', 'BOOKING_CANCELLED', 'BOOKING_REJECTED', 'BOOKING_IN_PROGRESS', 'BOOKING_COMPLETED', 'NEW_REVIEW', 'REVIEW_REQUESTED', 'NEW_MESSAGE', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'PROVIDER_APPLICATION_SUBMITTED', 'PROVIDER_APPLICATION_APPROVED', 'PROVIDER_APPLICATION_REJECTED', 'LEAD_ACCEPTED', 'WELCOME', 'ACCOUNT_UPDATED', 'ANNOUNCEMENT', 'PASSWORD_CHANGED', 'GENERAL');
...
CREATE TABLE "FeaturedService" (
    ...
    CONSTRAINT "FeaturedService_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "FeaturedService_tradeId_idx" ON "FeaturedService"("tradeId");

-- CreateIndex
CREATE INDEX "FeaturedService_isActive_idx" ON "FeaturedService"("isActive");

-- CreateIndex
CREATE INDEX "FeaturedService_sortOrder_idx" ON "FeaturedService"("sortOrder");
...
-- AddForeignKey
ALTER TABLE "FeaturedService" ADD CONSTRAINT "FeaturedService_tradeId_fkey" FOREIGN KEY ("tradeId") REFERENCES "Trade"("id") ON DELETE CASCADE ON UPDATE CASCADE;
